...
const productsList = data ? products.data.map((product)=>{return <ProductCard _id={product._id} key={product._id} price={product.price} name={product.name} image={product.avatar} />}) : null;
